...
function sg_load(sg_path, sg_main_category, sg_twidth, sg_theight, idWpisu) {
	if(sg_path=="") {
		var loader_path = "simplegallery/ajax/loader.php"; 
	} else {
		var loader_path = sg_path+"simplegallery/ajax/loader.php"; 
	}
	$.post(loader_path, { 
		action: "loadData",
		sg_path: sg_path,
