...
if(isset($_GET['i'])) {
	...
	/*if($file_type=='wma'){
		$original_image_gd = imagecreatefromjpeg("../../upload/music.jpg");
	}
	if($file_type=='wmv'){
		$original_image_gd = imagecreatefromjpeg("../../upload/play.jpg");
	}*/
...
if(isset($_GET['c'])) {
	...
	/*if($file_type=='wma'){
		$original_image_gd = imagecreatefromjpeg("../../upload/music.jpg");
		$original_image_size[0] = 683;
		$original_image_size[1] = 593;
	}
	if($file_type=='wmv'){
		$original_image_gd = imagecreatefromjpeg("../../upload/play.jpg");
		$original_image_size[0] = 317;
		$original_image_size[1] = 330;
	}*/
	if($file_type=='jpg'){
		$original_image_gd = imagecreatefromjpeg($file_name);
